...
**One line:** a GNOME/Wayland user daemon that extends an existing physical
desktop with virtual monitors, restores saved layouts by configured role, and
streams outputs independently through isolated Sunshine client instances.
